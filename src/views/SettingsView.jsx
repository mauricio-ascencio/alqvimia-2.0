              ...
              <div className="db-connections">
                <div className="db-connection-card">
                  ...
                  <div className="db-info">
                    ...
                    <span className="db-status connected"><i className="fas fa-circle"></i> Conectado</span>
                  </div>
                ...
                <div className="db-connection-card">
                  ...
                  <div className="db-info">
                    ...
                    <span className="db-status disconnected"><i className="fas fa-circle"></i> Desconectado</span>
                  </div>
                  <div className="db-actions">
                    <button className="btn btn-sm btn-secondary"><i className="fas fa-edit"></i></button>
